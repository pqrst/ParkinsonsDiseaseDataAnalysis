...
parkinson_model <- specifyModel(file = "C:\\c\\Rawls\\spring18\\MVA\\project\\parkinson_sem_model.txt")
...
parkinson.EFA <- factanal(parkinsons[, c(2:11,15:22)], 4, n.obs = nrow(parkinsons), rotation="varimax", 
                          scores = "regression")
parkinson.EFA
